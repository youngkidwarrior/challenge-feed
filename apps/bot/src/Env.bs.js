...
function createEnv(param) {
  ...
  var path = envFile !== undefined ? FindUp.findUpSync(envFile, undefined) : FindUp.findUpSync(".env", undefined);
  Dotenv.config({
        path: path
      });
...
function getConfig(param) {
  ...
  var match$2 = env("DISCORD_GUILD_ID");
  var match$3 = env("DISCORD_CHANNEL_ID");
  if (match.TAG === /* Ok */0) {
    if (match$1.TAG === /* Ok */0) {
      if (match$2.TAG === /* Ok */0) {
        if (match$3.TAG === /* Ok */0) {
          return {
                  ...
                  _0: {
                    ...
                    discordGuildId: match$2._0,
                    discordChannelId: match$3._0
                  }
                };
        } else {
          return match$3;
